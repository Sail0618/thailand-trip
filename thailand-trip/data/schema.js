...
const initialData = {
  ...
  // ---------- 预算估算（人均，可在线调整） ----------
  budget: [
    { id: "b1", item: "✈️ 国际机票", detail: "杭州↔香港↔曼谷 往返", amount: 3000 },
    { id: "b2", item: "✈️ 曼谷→清迈", detail: "越捷 VZ110", amount: 200 },
    { id: "b3", item: "✈️ 清迈→曼谷", detail: "待定", amount: 200 },
    { id: "b4", item: "✈️ 曼谷→甲米", detail: "待定", amount: 400 },
    { id: "b5", item: "✈️ 甲米→曼谷", detail: "已订 JF87V5", amount: 300 },
    { id: "b6", item: "🏨 住宿", detail: "9 晚（曼谷2+芭提雅2+清迈2+机场1+皮皮岛2）", amount: 3500 },
    { id: "b7", item: "🚗 交通", detail: "包车/打车/BTS/船票", amount: 1200 },
    { id: "b8", item: "🎫 活动门票", detail: "海天盛筵+99Show+大象营+海盗船+长尾船", amount: 1800 },
    { id: "b9", item: "🍜 餐饮", detail: "10 天 × 约 150/天", amount: 1500 },
    { id: "b10", item: "🛍️ 购物", detail: "伴手礼/药妆/免税", amount: 1000 },
    { id: "b11", item: "📋 其他", detail: "保险/电话卡/小费/马杀鸡", amount: 600 }
  ],

  // 10/3 返程冲突提示（保留原逻辑）
  alert: {
    title: "⚠️ 重要：10/3 返程路线冲突！",
    text: "皮皮岛返程原计划写的是 皮皮岛 → 普吉岛机场 → 曼谷，但已确认航班从 甲米机场 (KBV) 20:35 起飞（预订号 JF87V5）。两者不一致，需二选一：",
    options: [
      { name: "方案 A（推荐·不改航班）", desc: "皮皮岛通塞码头 → 坐船回甲米 Klong Jirad 码头（约1.5h）→ 打车去甲米机场 → 20:35 飞曼谷。优点：不用改机票；缺点：甲米码头到机场约30min车程，需预留充足时间" },
      { name: "方案 B（改航班）", desc: "皮皮岛通塞码头 → 坐船去普吉 Rassada 码头（约2h）→ 打车去普吉机场 (HKT) → 飞曼谷。优点：和原始计划一致；缺点：需退改 JF87V5 机票" }
    ]
  },
